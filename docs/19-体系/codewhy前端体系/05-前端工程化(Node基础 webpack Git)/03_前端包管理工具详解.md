**包管理工具详解 ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.001.png)![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.002.png)![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.003.png)**

**npm、yarn、cnpm、npx、pnpm** 

王红元 coderwhy![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.004.png)

![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.005.png) ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.006.png)

|**目录 content**|**1![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.007.png)**|**npm包管理工具**|
| :- | - | - |
||**2![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.008.png)**|**package配置文件**|
||**3![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.009.png)**|**npm install原理**|
||**4![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.010.png)**|**yarn、cnpm、npx**|
||**5![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.011.png)**|**发布自己的开发包**|
||**6![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.012.png)**|**pnpm使用和原理**|
...
- node管理工具：http[s://nodejs.org/en/，安装Node](https://nodejs.org/en/)的过程会自动安装npm工具；
- **npm管理的包可以在哪里查看、搜索呢？**
- <https://www.npmjs.org/>
- 这是我们安装相关的npm包的官网；
- **npm管理的包存放在哪里呢？**
...
Vue CLI4创建的Vue3项目 create-react-app创建的react17项目

npm init #创建时填写信息 ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.014.jpeg)![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.015.jpeg)
...
![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.018.png) **常见的属性 ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.019.png)**
...
- **项目安装会在当前目录下生成一个 node\_modules 查找；**

**文件夹，我们之前讲解require查找顺序时有讲解过这个包在什么情况下被**


- **局部安装分为开发时依赖和生产时依赖：**
- 默认安装开发和生产依赖 npm install axios npm i axios
- 开发依赖
...
![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.020.jpeg)
...
- **package-lock.json文件解析： ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.021.jpeg)**
- name：项目的名称； 
- version：项目的版本； 
...
- **由于一些特殊的原因，某些情况下我们没办法很好的从 https://registry.npmjs.org**
- 查看npm镜像：
...
- **注册npm账号： ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.023.jpeg)**
...
window: copy foo.js foo\_copy.js ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.029.png)macos : cp foo.js foo\_copy.js 

- **文件的硬链接 ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.030.png)**

window: mklink /H aaa\_hard.js aaa.js macos : ln foo.js foo\_hard.js 

- **文件的软连接： ![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.031.png)**

window: mklink aaa\_soft.js aaa.js macos : ln -s foo.js foo\_copy.js 


**pnpm到底做了什么呢？**


- **当使用 npm 或 Yarn 时，如果你有 100 个项目，并且所有项目都有一个相同的依赖包，那么， 你在硬盘上就需要**
...
- **当使用 npm 或 Yarn Classic 安装依赖包时，所有软件包都将被提升到 node\_modules 的 根目录下。**
- 其结果是，源码可以访问 本不属于当前项目所设定的依赖包；

![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.033.jpeg)
...
**npm 命令 pnpm 等价命令![](./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.035.png)**

npm install pnpm install

npm install <pkg> pnpm add <pkg> npm uninstall <pkg> pnpm remove <pkg> npm run <cmd> pnpm <cmd>
...
[ref1]: ./image/Aspose.Words.77560a88-720a-4e1e-85da-e338972abaee.013.png
