**React组件化开发（一） ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.001.png)![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.002.png)![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.003.png)**

王红元 coderwhy![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.004.png)

![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.005.png) ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.006.png)

|**目录 content**|**1![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.007.png)**|**React的组件化开发**|
| :- | - | - |
||**2![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.008.png)**|**React组件生命周期**|
||**3![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.009.png)**|**React组件间的通信**|
||**4![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.010.png)**|**React组件插槽用法**|
||**5![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.011.png)**|**React非父子的通信**|
||**6![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.012.png)**|**setState的使用详解**|

**什么是组件化开发呢？**

- **组件化是一种分而治之的思想：**
- 如果我们将一个页面中所有的处理逻辑全部 ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.014.jpeg)放在一起，处理起来就会变得非常复杂，而 且不利于后续的管理以及扩展。 
...
- **函数组件是使用function来进行定义的函数，只是这个函数会返回和类组件中**
...
- **React内部为了告诉我们当前处于哪些阶段，会对我们组件内部实现的某些函数进行回调**
...
![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.018.jpeg)

**生命周期函数**

- **Constructor**
- 如果不初始化 state 或不进行方法绑定，则不需要为
- constructor中通常只做两件事情：
- 通过给 this.state 赋值对象来初始化内部的
- 为事件绑定实例（this）；

React 组件实现构造函数。 

state； ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.019.png)

**生命周期函数**

- **componentDidMount ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.020.png)**
...
- getDerivedStateFromProps：state 的值在任何 ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.021.jpeg)时候都依赖于 props时使用；该方法返回一个对象 来更新state； 
...
- **上面的嵌套逻辑如下，它们存在如下关系： ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.022.png)**
...
![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.023.jpeg) ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.024.png)

**参数propTypes**

- 对于传递给子组件的数据，有时候我们可能希望进行验证，特别是对于大型项目来说：
  - 当然，如果你项目中默认继承了Flow或者TypeScript，那么直接就可以进行类型验证； ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.025.png)
...
- 比如验证数组，并且数组中包含哪些元素； ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.026.png)
...
![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.029.png)
...
![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.030.jpeg) ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.031.png)

**props实现插槽**

- **通过children实现的方案虽然可行，但是有一个弊端：通过索引值获取传入的元素很容易出错，不能精准的获取传入的原生；**
- **另外一个种方案就是使用 props 实现：**
- 通过具体的属性名，可以让我们在传入和获取时更加的精准；![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.032.jpeg)![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.033.jpeg)
...
![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.039.jpeg)

**setState异步更新**

- **setState的更新是异步的？ ![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.040.png)**
- 最终打印结果是Hello World； 
...
- 验证一：在setTimeout中的更新：
  - 其实分成两种情况：![](./image/Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.043.png)
    - 在组件生命周期或React合成事件中，setState是异步；
- 验证二：原生DOM事件： ➢ 在setTimeout或者原生dom事件中，setState是同步；
...
[ref1]: Aspose.Words.b286cbd1-fee5-4d76-9620-5cec06bb1474.013.png
