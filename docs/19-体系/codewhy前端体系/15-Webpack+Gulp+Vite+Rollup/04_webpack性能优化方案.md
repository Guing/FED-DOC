**webpack性能优化方案（一） ![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.001.png)![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.002.png)![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.003.png)**

王红元 coderwhy![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.004.png)

![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.005.png) ![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.006.png)
...
**Entry Dependencies(入口依赖)![ref1]**

- **假如我们的index.js和main.js都依赖两个库：**
- 如果我们单纯的进行入口分离，那么打包后的两个
- 事实上我们可以对他们进行共享；

**lodash、dayjs**

bunlde都有会有一份lodash和dayjs；

![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.015.png)

**动态导入(dynamic import)![ref1]**
...
**optimization.runtimeChunk配置![ref1]**
...
- 设置的值：
- true/multiple：针对每个入口打包一个runtime文件； ![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.025.png)
- single：打包一个runtime文件； 
- 对象：name属性决定runtimeChunk的名称； 

**Prefetch和Preload![ref1]**
...
- **CDN称之为内容分发网络（Content Delivery Network或Content Distribution Network**
...
- 在开发中，我们使用CDN主要是两种方式：![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.027.png)
...
- **目前我们的lodash、dayjs都使用了CDN进行引入，所以相当于在全局是可以使用**
...
- ProvidePlugin能够帮助我们在每个模块中，通过一个变量来获取一个package； ![](./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.033.png)
...
**MiniCssExtractPlugin![ref1]**

- **MiniCssExtractPlugin可以帮助我们将css提取到一个独立的**
- **首先，我们需要安装 mini-css-extract-plugin：**

**css文件中，该插件需要在webpack4+才可以使用。**
...
**Hash、ContentHash、ChunkHash![ref1]**
...
[ref1]: ./image/Aspose.Words.81716918-a676-4933-91b2-152c66b90168.013.png
